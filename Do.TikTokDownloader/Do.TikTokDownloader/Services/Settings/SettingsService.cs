...
namespace Do.TikTokDownloader.Services.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        private readonly bool _IsFirstLoginDefault = true;
        private const string _IsFirstLogin = "_IsFirstLogin";
        #endregion

        #region Settings Properties
        public bool IsFirstLogin
        {
            get => GetValueOrDefault(_IsFirstLogin, _IsFirstLoginDefault);
            set => AddOrUpdateValue(_IsFirstLogin, value);
        }
        #endregion
